...
#### Folks Involved: C. Lem, H. Kim, D. Caballero
Over the last few decades, research in higher education has discovered that a concerning percentage of students who enter college as STEM majors switch to non-STEM majors or drop out of college altogether (Seymour et al. 2019). Additional research has suggested that gateway STEM coursework is a significant factor in the high rates of attrition (PCAST 2012). In response to this, higher education institutions have attempted to “transform” these courses to result in improved outcomes for students. For instance, at MSU, there has been an effort over the last several years to transform gateway course sequences in physics, chemistry, and biology using the 3-Dimensional Learning (3DL) framework. Our work aims to use interviews with faculty, institutional data, and machine learning to assess the impact of this course transformation on retention in STEM at MSU, which will build on existing findings of how transformation has correlated with student success in these courses (Matz et al. 2017). Ultimately, this work provides an evidence-based account of how large-scale course transformations shape STEM retention and offers a model for how institutional data can be used to evaluate similar initiatives.
