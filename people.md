...
#### Tom Finzell
{% include figure.html image="/assets/img/TomFinzell_headshot.png" position="left" width="120px" %}
...
Paul is an assistant professor in CMSE. His research is based out of CERL and he teaches CMSE 201 and STT 180. He finished his PhD in 2021 doing physics education research at MSU, studying how high school students perceive and deal with affect-based challenges when learning physics through computation. He is interested broadly in the intersection of computing, disciplinary learning, and affect. His current research focuses on CMSE 201 (an introductory interdisciplinary computing course), and involves students’ perspectives on self-efficacy for interdisciplinary computing, the impact of personalized written feedback on students, and curriculum design for three-dimensional learning and sustainability. Outside of work, Paul loves to play with his German shorthaired pointer, explore Michigan’s parks and breweries, and make linocuts.
